                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="register.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name= "inputCompanyName"id="inputCompanyName" placeholder="Enter Company Name">
                                </div>
                                <div>
                                    <button class="btn btn-primary btn-user btn-block" type="submit" name="btn_register" value="Register">Register</button>
                                </div>
