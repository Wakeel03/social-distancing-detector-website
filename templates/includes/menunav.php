<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-people-arrows  4x"></i>
                </div>
                <div class="sidebar-brand-text mx-3">CROWD VISION</div>
            </a>
            ...
            <li  <?php 
					  if ($activemenu=="camera" || $activemenu == "activecamera"){    
					  	echo "class=\"nav-item active\"";
					       	}
					   else{
					  	echo "class=\"nav-item\"";
                ...
                <div id="collapseTwo" <?php 
					  if ($activemenu=="camera"||$activemenu == "activecamera"){    
					  	...
					  	echo "class=\"collapse hide\"";
					        }
    						  ?> aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">My Cams</h6>
                        <a <?php 
					  if ($activemenu=="camera"){    
					  	echo "class=\"collapse-item active\"";
					       	}
					   else{
					  	echo "class=\"collapse-item\"";
					        }
    						  ?> href="cameras.php">View cams</a>
                        <a <?php 
					  if ($activemenu=="activecamera"){    
					  	echo "class=\"collapse-item active\"";
					       	}
					   else{
					  	echo "class=\"collapse-item\"";
					        }
    						  ?>  href="active-cam.php">Active camera</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - About Us -->
            <li class="nav-item">
                <a class="nav-link" href="USEFUL/charts.html">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search [NOT NEEDED FOR NOW]-->
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        Camera 2: Critical threshold exceeded.
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">pravin</span>
